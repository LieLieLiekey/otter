...
mvn install:install-file -DgroupId=com.alibaba.fastsql -DartifactId=fastsql -Dversion=2.0.0_preview_644 -Dpackaging=jar -DpomFile=fastsql-2.0.0_preview_644.pom -Dfile=fastsql-2.0.0_preview_644.jar -Dsources=fastsql-2.0.0_preview_644-sources.jar
